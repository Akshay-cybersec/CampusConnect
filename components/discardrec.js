    ...
    const Record = () => {
        ...
        const deleteres = async () => {
            try {
                ...
                const url = "https://good-amazingly-starling.ngrok-free.app/campusconnectdelete/" + rollno
            ...
            <View style={{ flex: 1, backgroundColor: COLORS.appcol }}>
                ...
                <View style={{ flex: 5, backgroundColor: 'white', borderTopRightRadius: 17, borderTopLeftRadius: 17, paddingHorizontal: 15, alignItems: 'center' }}>
                    <View style={{ flex: 1, justifyContent: 'center', alignContent: 'center' }}>
                        <Text style={{ fontSize: 20, fontWeight: '700', textAlign: 'center' }}>Discard student record</Text>
                    </View>
